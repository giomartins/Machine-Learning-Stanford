...
a3 = sigmoid(z3);                 % hypothesis h_theta(x)
...
for t = 1:m
    % Step 1: Forward pass (example t)
    a1t = a1(t, :)';              % (input_layer_size + 1) x 1
    z2t = Theta1 * a1t;
    a2t = [1; sigmoid(z2t)];
    z3t = Theta2 * a2t;
    a3t = sigmoid(z3t);

    yt = Y(t, :)';                % num_labels x 1
